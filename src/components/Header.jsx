        ...
        <header className='header-container'>
            ...
            <section className='name-container'>
                ...
                className='gradiant-effect-for-text2'
                    ...
                    transition={{ easeOut: "ease", duration: .7 }}
                >del Cid Flores</motion.h2>
            </section>
            <motion.button
             ...
             >¡Contáctame!</motion.button>

            </div>
            <section >
            <Reorder.Group className='technologies' axis="x" values={items} onReorder={setItems}>
                {
                    items.map(item => (
                        <Item
